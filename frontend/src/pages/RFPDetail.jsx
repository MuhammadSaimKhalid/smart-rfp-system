...
import { Download, XCircle, Upload, CheckCircle, X, MessageSquare, Briefcase, FileText, FileSpreadsheet } from 'lucide-react';
...
export default function RFPDetail() {
    ...
    return (
        <div className="animate-fade-in pb-12">
                    ...
                    <div className="bg-white rounded-xl border border-slate-200 overflow-hidden shadow-sm">
                        <div className="p-4 border-b border-slate-100 flex justify-between items-center bg-slate-50">
                            ...
                            <div className="flex gap-4 items-center">
                                ...
                                >
                                    <FileSpreadsheet size={16} /> Compare Submitted Forms
                                </button>
            ...
            <ComparisonMatrixModal rfpId={id} isOpen={isMatrixOpen} onClose={() => setIsMatrixOpen(false)} />
        </div>
    );
}
